...
| Iron Will | 150 | Your imprisonment vote counts **double** | **This** consultation (votes summed by weight in `resolve_consultation`/`consultation_tally`); cleared after. **Only buyable from round 2 on** (`day >= 2`). | **DONE (075)** |
