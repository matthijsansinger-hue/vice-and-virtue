...
|---|---|---|---|---|
| Kill | 300 | Kill a target | Next reflection (`resolve_role_action`); protection-blockable | **DONE (2b)** |
| Hospitalise | 200 | Hospitalise a target 1 day | Next reflection; protection-blockable | **DONE (2b)** |
| Protection | 200 | Shield self | Next reflection — blocks Murder/Intox + potion kills/hospitalise | **DONE (2b)** |
...
src/components/
  ...
  abilities/
    ...
    FanaticismAction.tsx (plant / see-carriers), BombPassPanel.tsx (any holder's pass prompt), FanaticismDetonate.tsx (consultation detonate)  # new-role abilities batch 3 (068)
src/app/
