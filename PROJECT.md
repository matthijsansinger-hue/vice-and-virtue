...
| Protection | 200 | Shield self | When the shop closes — blocks this shop's potion kills/hospitalise + sacrifices (NOT Murder/Intox, which are role-action; NOT bomb detonations, which are unblockable) | **DONE (2b/072)** |
