...
src/lib/
  ...
  rankedQueue.ts                 # ranked queue: MODE_SIZE {3v3:3,5v5:5}, joinQueue/leaveQueue/getQueueCounts/tryMatchmake/getMyQueue/resolveMySeat (resolves the server-created seat → vv_player_id before navigating)
